...
public class DownhillSimplex_IsConverging
{
    ...
    private double[] DF;
    private double p1, p2, p3, p4, p5, p6, p7, p8, p9, p10, p12, p15, p20;
    ...
    public void SetUp()
    {
        ...
        ODF = new OptimalDiscountFactors(100 * (p1 + creditrisk), 100 * (p2 + creditrisk), 100 * (p3 + creditrisk),
